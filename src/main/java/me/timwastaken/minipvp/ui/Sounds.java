...
//    WITHER_SPAWN(Sound.ENTITY_WITHER_SPAWN, 1f, 1f),
    GAME_END(Sound.WITHER_SPAWN, 1f, 0.5f),
...
//    PAUSE_GAME(Sound.ENTITY_ENDER_DRAGON_GROWL, 1f, 1f),
    COUNTDOWN(Sound.NOTE_BASS, 1f, 1f),
    RESUME_GAME(Sound.LEVEL_UP, 1f, 2f),
    PLAYER_DEATH(Sound.AMBIENCE_THUNDER, 1f, 1f),
    PLAYER_ELIMINATION(Sound.WITHER_DEATH, 1f, 1f),
    FIGHT_ANNOUNCEMENT(Sound.ANVIL_USE, 1f, 0.5f);
